...
export const ingredients: Ingredient[] = [
  ...
  },
  {
    ...
    category: 'liqueurs',
    color: 'from-purple-300 to-purple-500',
    position: { section: 'back-bar', row: 1, col: 12 }
  },
  {
    id: 'cherry-heering',
    name: 'Cherry Heering',
    ...
    position: { section: 'back-bar', row: 1, col: 13 }
  },

  // Back Bar - Row 2 (Wines & Bitters)
  {
    id: 'aperol',
    name: 'Aperol',
    category: 'liqueurs',
